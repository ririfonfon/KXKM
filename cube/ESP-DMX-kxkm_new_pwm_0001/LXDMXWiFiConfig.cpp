...
void DMXwifiConfig::initConfig(void) {
  ...
  _wifi_config->protocol_flags = ARTNET_MODE | STATIC_MODE;     // sACN multicast mode
  ...
  strcpy((char*)_wifi_config->node_name, "esp_001");
